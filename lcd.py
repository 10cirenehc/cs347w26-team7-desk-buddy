...
# COLOUR PALETTE
# ─────────────────────────────────────────────────────────────────────────────
C_BG        = (10,  10,  20)      # near-black navy
C_ACCENT    = (0,   180, 255)     # cyan-blue
C_ACCENT2   = (255, 80,  120)     # coral / alarm red
C_TEXT      = (230, 235, 255)
...
def draw_notification(message, detail=""):
    ...
    for w in words:
        test = (line + " " + w).strip()
        bbox = d.textbbox((0,0), test, font=FONT_MED)
